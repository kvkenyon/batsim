...
#[openapi(
    ...
    paths(
        ...
        crate::routes::backtests::create_backtest,
        crate::routes::backtests::list_backtests,
        crate::routes::backtests::get_backtest,
        crate::routes::backtests::get_settlement,
    ...
    components(schemas(
        ...
        crate::model::RetailRateSpec,
        crate::model::TouWindowSpec,
        crate::model::StrategyAction,
        crate::model::StrategyEntrySpec,
        crate::model::StrategySpec,
        crate::model::AsProductSpec,
        crate::model::AsAwardSpec,
        crate::model::FourCpSpec,
        crate::model::BacktestRequest,
        crate::model::BacktestDoc,
        crate::model::BacktestsPage,
    ...
    tags(
        ...
        (name = "backtests", description = "ERCOT replay backtests with settlement"),
