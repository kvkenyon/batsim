...
| HVAC stochastic `R_hvac` | Duty-cycle model: shape x temperature multiplier / rated power; per-home period +/-10 % and phase +/-5 min (LoadPhase draws). Heat-pump aux strip +3-5 kW below 2 C. Cool setpoint 24 C / heat 20 C are mode constants. | **ResStock** duty-cycle statistics. |
